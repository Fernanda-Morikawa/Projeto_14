 ...
 background(0);
  ...
  if (World.frameCount % 100 == 0) {
   switch(select_balloon) {
    case 1:redBalloon(red_balloonImage) //chamar o balão vermelho
    break;
    case 2:blueBalloon(blue_balloonImage) // chamar o balão azul
    break;
    case 3:greenBalloon(green_balloonImage) // chamar o balão verde
    break;
    case 4:pinkBalloon(pink_balloonImage) // chamar o balão rosa
    break;
    default:break;
  }}
...
function pinkBalloon() {
 //crieSprite para o balão
  var pink = createSprite(0,Math.round(randon(20, 370)), 10, 10);
  //adicioneImagem para o balão
